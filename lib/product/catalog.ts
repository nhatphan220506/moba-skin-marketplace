...
export const catalog: CatalogItem[] = [
  { id: 1, name: "Verdant Sentinel", artist: "0x7099…79C8", game: "Demo MOBA", status: "Market ready", edition: "1 of 1", price: "200", priceLabel: "Resale price", votes: 2, category: "Tank", palette: "verdant", source: "onchain-demo", description: "A publisher-authorised guardian concept with a limited, transferable in-game usage entitlement." },
  ...
  { id: 3, name: "Astral Weaver", artist: "NovaLines", game: "Demo MOBA", status: "Community vote", edition: "Concept", price: "72%", priceLabel: "Community support", votes: 921, category: "Mage", palette: "violet", source: "product-preview", description: "Celestial fabric and constellation magic shaped by the community selection season." },
  ...
  { id: 5, name: "Solar Requiem", artist: "Atelier IX", game: "Demo MOBA", status: "In review", edition: "Concept", price: "4 files", priceLabel: "Evidence package", votes: 0, category: "Marksman", palette: "solar", source: "product-preview", description: "A ceremonial marksman concept entering provenance and publisher eligibility review." },
