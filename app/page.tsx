...
export default function HomePage() {
  return <main className="home-main">
    ...
    <section className="home-section"><div className="section-lead"><div><p className="eyebrow">CURATED THIS SEASON</p><h2>Built by the community.<br/>Cleared for the game.</h2></div><Link className="text-link" href="/explore">View all season assets ↗</Link></div><div className="home-catalog">{catalog.slice(1,4).map(item => <ProductCard item={item} key={item.id}/>)}</div><p className="catalog-disclosure">Verdant Sentinel is the executed demo asset. Additional season cards demonstrate the complete product experience and are clearly marked as previews.</p></section>
